...
pub const SETTINGS: &[Setting] = &[
    // ------------------------------------------------------------- general
    s("general", "General", "Open at login", "startup boot autostart windows"),
    s("general", "General", "Show in the system tray", "tray notification area icon"),
    s("general", "General", "Summon hotkey", "shortcut keybind alt space keyboard"),
    s("general", "General", "Hide when it loses focus", "blur dismiss escape close"),
    s("general", "General", "Select the search text", "query summon replace typing"),
    s("general", "General", "Return to the root list", "reset summon root back"),
    // ---------------------------------------------------------- appearance
    s("appearance", "Appearance", "Interface font", "typeface inter segoe type crisp"),
    s("appearance", "Appearance", "Backdrop", "acrylic blur glass material transparency"),
    s("appearance", "Appearance", "Backdrop depth", "tint alpha dark opacity"),
    s("appearance", "Appearance", "Glass strength", "solid opaque transparency"),
    s("appearance", "Appearance", "Rows before scrolling", "height size window rows"),
    s("appearance", "Appearance", "Window width", "width size window"),
    // ----------------------------------------------------------- dictation
    s("dictation", "Dictation", "Dictation", "voice speech whisper microphone talk"),
    s("dictation", "Dictation", "Start dictating", "shortcut hotkey trigger push talk"),
    s("dictation", "Dictation", "What happens to the transcript", "paste clipboard output"),
    s("dictation", "Dictation", "Use the system default microphone", "input device audio mic"),
    s("dictation", "Dictation", "Microphone priority order", "input device headset rank"),
    s("dictation", "Dictation", "Mute while recording", "audio speakers music silence"),
    s("dictation", "Dictation", "Language", "english auto detect locale"),
    s("dictation", "Dictation", "Finish and cancel keys", "enter escape space discard"),
    s("dictation", "Dictation", "Ask before discarding", "confirm cancel warning discard"),
    s("dictation", "Dictation", "Start and stop cues", "sound effects audio feedback tone"),
    s("dictation", "Dictation", "Keep a history", "transcripts record statistics"),
    s("dictation", "Dictation", "Transcription backend", "local whisper openai groq api"),
    s("dictation", "Dictation", "API key", "token secret credential openai groq"),
    s("dictation", "Dictation", "Custom endpoint", "url server remote host base"),
    s("dictation", "Dictation", "Custom instructions", "prompt guidance style spelling"),
    s("dictation", "Dictation", "Use the frontmost application", "app context window prompt"),
    s("dictation", "Dictation", "Vocabulary", "prompt names jargon bias terms"),
    s("dictation", "Dictation", "Speech model", "whisper tiny base small medium download"),
    // Dictation's own history, inside dictation where it belongs.
    s("dictation", "Dictation", "Dictation transcripts", "history past search transcript"),
    s("dictation", "Dictation", "Clear dictation history", "delete forget wipe transcripts"),
    s("dictation", "Dictation", "Dictation statistics", "words per minute time saved wpm"),
    // ------------------------------------------------------------ snippets
    ...
    // ----------------------------------------------------------- clipboard
    s("clipboard", "Clipboard History", "Record what I copy", "clipboard history paste enable"),
    s("clipboard", "Clipboard History", "Keep history for", "retention days delete old expire"),
    s("clipboard", "Clipboard History", "Keep images", "screenshots pictures clipboard"),
    s("clipboard", "Clipboard History", "Excluded applications", "ignore private password exclude"),
    s("clipboard", "Clipboard History", "Clear clipboard history", "delete wipe entries"),
    // ------------------------------------------------------------- sources
    s("sources", "Sources", "Start Menu, Desktop and taskbar", "shortcuts lnk pinned"),
    s("sources", "Sources", "Store and packaged applications", "appx uwp store msix"),
    s("sources", "Sources", "Registered executables", "app paths registry run"),
    s("sources", "Sources", "Installed programs", "uninstall registry programs"),
    s("sources", "Sources", "Executables on PATH", "cli command line exe path"),
    s("sources", "Sources", "Windows settings pages", "control panel applets"),
    s("sources", "Sources", "Hidden entries", "exclude filter block ignore hide"),
    // --------------------------------------------------------------- files
    s("files", "File Search", "Search files", "everything voidtools enable"),
    s("files", "File Search", "Maximum file results", "limit count results"),
    s("files", "File Search", "Match the whole path", "path folder match"),
    s("files", "File Search", "Match case", "case sensitive"),
    s("files", "File Search", "Regular expression", "regex pattern"),
    s("files", "File Search", "Folders to search", "scope only restrict directories"),
    // ---------------------------------------------------------- extensions
    s("extensions", "Extensions", "Installed extensions", "raycast host node commands"),
    // ------------------------------------------------------------ advanced
    s("advanced", "Advanced", "Rebuild the index", "reload rescan reindex refresh"),
    s("advanced", "Advanced", "Usage history", "frecency ranking forget clear reset"),
    s("advanced", "Advanced", "Data folder", "appdata preferences cache open"),
    s("advanced", "Advanced", "Log", "diagnostics debug error output"),
    // --------------------------------------------------------------- about
